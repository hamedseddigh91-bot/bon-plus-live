...
export default async function Page() { const initialState = await getRecipeCostingState(); return <AdminShellServer requiredModule="operations"><RecipeCostingPage initialState={initialState} /></AdminShellServer>; }
