...
export const adminText = {
  fa: {
    ...
    pageFinanceSubtitle: "داشبورد مالی، صندوق، فاکتورها، تنخواه و دوره‌ها.",
    ...
    pageQaTitle: "مرکز تست آنلاین",
    pageQaSubtitle: "چک‌لیست تست نسخه آنلاین، آماده‌سازی دمو و گزارش باگ توسط تیم.",
  ...
  ar: {
    ...
    pageFinanceSubtitle: "لوحة المالية، الصندوق، الفواتير، العهدة والفترات.",
    ...
    pageQaTitle: "مركز الاختبار أونلاين",
    pageQaSubtitle: "قائمة اختبار النسخة الأونلاين، تجهيز الديمو وتسجيل الملاحظات من الفريق.",
  ...
  en: {
    ...
    pageFinanceSubtitle: "Finance dashboard, cash closing, invoices, petty cash and periods.",
    ...
    pageQaTitle: "Online Testing Center",
    pageQaSubtitle: "Checklist for online testing, demo readiness and staff bug reports.",
