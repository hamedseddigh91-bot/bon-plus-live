...
export const adminText = {
  fa: {
    ...
    pageFinanceSubtitle: "صندوق، فاکتورها، تنخواه و قیمت تمام‌شده.",
    pageCrmTitle: "CRM",
  ...
  ar: {
    ...
    pageFinanceSubtitle: "الصندوق، الفواتير، العهدة والتكلفة.",
    pageCrmTitle: "CRM",
  ...
  en: {
    ...
    pageFinanceSubtitle: "Cash closing, invoices, petty cash and costing.",
    pageCrmTitle: "CRM",
