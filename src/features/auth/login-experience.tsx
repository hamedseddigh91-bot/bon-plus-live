  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0">
        ...
        />
        <div
          className="absolute -left-32 top-1/3 h-96 w-96 rounded-full bg-[#1f6bff]/25 blur-[120px]"
          aria-hidden="true"
        />
        <div
          className="absolute right-10 top-10 h-72 w-72 rounded-full bg-[#2fa8ff]/20 blur-[120px]"
          aria-hidden="true"
        />
      </div>
