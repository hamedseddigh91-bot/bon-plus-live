...
export function ActivityLogViewer({ initialState, initialDate }: ActivityLogViewerProps) {
  ...
  const panel="rounded-[2rem] border border-[color:var(--admin-border)] bg-[color:var(--admin-card)] shadow-[0_24px_70px_rgba(0,0,0,0.14)]";
