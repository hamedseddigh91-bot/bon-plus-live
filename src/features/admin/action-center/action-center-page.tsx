...
const copy = {
  fa: {
    ...
    itemTitles: {
      ...
      "Multiple financial periods are open": "چند دوره مالی همزمان باز هستند",
      "Financial period needs closing": "دوره مالی نیاز به بستن دارد",
  ...
  ar: {
    ...
    itemTitles: {
      ...
      "Multiple financial periods are open": "هناك عدة فترات مالية مفتوحة",
      "Financial period needs closing": "الفترة المالية تحتاج إلى إغلاق",
